...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_8'                                                                                         # Name of the simulation
...
# ------------------------------------------
setupDat['inp'] = ['Tc', 'Ta', 'Us', 'Is', 'Wm', 'Tm']                                                                  # names of the input variables (X) if empty all
setupDat['out'] = ['T_sw']                                                                                              # names of the output variables (y)
...
setupPar['solver'] = 'CL'                                                                                               # solver 1) 'SP': Signal Processing, 2) 'ML': Machine Learning, 3) 'DL': Deep Learning, 4) 'SF': Short Term Time-Series Forecasting, 5) 'CL': Closed Loop
...
# ------------------------------------------
setupPar['lag'] = -60                                                                                                   # lagging between input (X) and output (y) in samples
