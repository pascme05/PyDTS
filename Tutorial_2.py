...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_2'                                                                                               # Name of the simulation
...
# ------------------------------------------
setupDat['inp'] = ['P1', 'P2', 'P3']                                                                                    # names of the input variables (X) if empty all
setupDat['out'] = ['P1']                                                                                                # names of the output variables (y)
...
setupPar['model'] = 'DNN'                                                                                               # possible models 1) SP: State Space (SS), Transfer Function (TF), 2) ML: RF, KNN, SVM, 3) DL: CNN, LSTM, DNN

# ------------------------------------------
# Framing and Features
# ------------------------------------------
setupPar['lag'] = -24                                                                                                   # lagging between input (X) and output (y) in samples
