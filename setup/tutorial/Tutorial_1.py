...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_1'                                                                                         # Name of the simulation
...
setupDat['rT'] = 23/24                                                                                                  # training proportion (0, 1)
...
setupDat['out'] = ['FRE', 'HPE', 'CDE']                                                                                 # names of the output variables (y)
...
setupPar['window'] = 10                                                                                                 # window length (samples)
setupPar['overlap'] = 9                                                                                                 # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 0                                                                                                  # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 5                                                                                                  # focus point for seq2point (average if -1)
