...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_7'                                                                                         # Name of the simulation
...
# Datasets
# ------------------------------------------
setupDat['train'] = ['Tutorial_7']                                                                                      # name of training datasets (multiple)
setupDat['test'] = 'Tutorial_7'                                                                                         # name of testing datasets (one)
setupDat['val'] = 'Tutorial_7'                                                                                          # name of validation dataset (one)

# ------------------------------------------
# Input/ Output Mapping
# ------------------------------------------
setupDat['inp'] = ['Solar', 'Wind', 'Speed', 'Irradiance', 'Temperature']                                               # names of the input variables (X) if empty all
setupDat['out'] = ['Solar']                                                                                             # names of the output variables (y)
setupDat['his'] = ['Wind']                                                                                              # names of the historic exogenous input (his) for short term load-forecasting
setupDat['fut'] = ['Speed', 'Irradiance', 'Temperature']                                                                # names of the future exogenous input (fut) for short term load-forecasting

# ------------------------------------------
# Sampling
# ------------------------------------------
setupDat['fs'] = 1/3600                                                                                                 # sampling frequency (Hz)
...
setupDat['outNorm'] = 0                                                                                                 # normalising output values (y): 0) None, 1) -1/+1, 2) 0/1, 3) avg/sig
...
setupPar['frame'] = 0                                                                                                   # 0) no framing, 1) framing
...
setupPar['window'] = 168                                                                                                # window length (samples)
setupPar['overlap'] = 0                                                                                                 # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 0                                                                                                  # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 167                                                                                                # focus point for seq2point (average if -1)
setupPar['nDim'] = 3                                                                                                    # input dimension for model 2) or 3)

# ------------------------------------------
# Postprocessing
# ------------------------------------------
setupPar['rank'] = 0                                                                                                     # 0) no feature ranking, 1) feature ranking, 2) Ranking Inp-Out, 3) Ranking Inp-Inp
