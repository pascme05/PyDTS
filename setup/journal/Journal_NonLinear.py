...
# Names
# ------------------------------------------
setupExp['name'] = 'Journal_NonLinear'                                                                                  # Name of the simulation
...
setupExp['test'] = 0                                                                                                    # 0) no testing, 1) testing
...
setupDat['idT'] = [60, 62, 74]                                                                                          # list of testing ids for method 3)
...
# ------------------------------------------
setupDat['inp'] = []                                                                                                    # names of the input variables (X) if empty all 'Tc', 'Ta', 'Us', 'Is', 'Wm', 'Tm'
...
setupPar['window'] = 600                                                                                               # window length (samples)
setupPar['overlap'] = 595                                                                                               # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 0                                                                                                  # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 599                                                                                                # focus point for seq2point (average if -1)
...
setupPar['outMin'] = -25                                                                                                # limited output values (minimum)
setupPar['outMax'] = 150                                                                                                # limited output values (maximum)
