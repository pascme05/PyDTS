...
# Topic:        Black-Box Modeling (Forecasting)
# File:         Journal Forecast
# Date:         17.01.2024
...
# Names
# ------------------------------------------
setupExp['name'] = 'Journal_Forecast'                                                                                   # Name of the simulation
...
# Datasets
# ------------------------------------------
setupDat['train'] = ['Tutorial_2']                                                                                      # name of training datasets (multiple)
setupDat['test'] = 'Tutorial_2'                                                                                         # name of testing datasets (one)
setupDat['val'] = 'Tutorial_2'                                                                                          # name of validation dataset (one)

# ------------------------------------------
# Input/ Output Mapping
# ------------------------------------------
setupDat['inp'] = []                                                                                                    # names of the input variables (X) if empty all
setupDat['out'] = ['P2']                                                                                                # names of the output variables (y)
...
# Sampling
# ------------------------------------------
setupDat['fs'] = 1/600                                                                                                  # sampling frequency (Hz)
...
setupDat['threshold'] = 2e4                                                                                             # 0) no threshold x) threshold to transform regressio into classification data
...
# ------------------------------------------
setupPar['lag'] = -144                                                                                                  # lagging between input (X) and output (y) in samples
...
setupPar['window'] = 144                                                                                                # window length (samples)
setupPar['overlap'] = 143                                                                                               # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 0                                                                                                  # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 143                                                                                                # focus point for seq2point (average if -1)
...
setupPar['outMax'] = 60e3                                                                                               # limited output values (maximum)
