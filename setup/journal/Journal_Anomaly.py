...
# Topic:        Black-Box Modeling (Anomaly Modelling)
# File:         Journal_Anomaly
# Date:         17.01.2024
...
from mdlParaJournal import mdlParaJournal
...
# Names
# ------------------------------------------
setupExp['name'] = 'Journal_Anomaly'                                                                                    # Name of the simulation
...
setupDat['rT'] = 0.7                                                                                                    # training proportion (0, 1)
setupDat['rV'] = 0.1                                                                                                    # validation proportion (0, 1) as percentage from training proportion
...
# Datasets
# ------------------------------------------
setupDat['train'] = ['Tutorial_4']                                                                                      # name of training datasets (multiple)
setupDat['test'] = 'Tutorial_4'                                                                                         # name of testing datasets (one)
setupDat['val'] = 'Tutorial_4'                                                                                          # name of validation dataset (one)

# ------------------------------------------
# Input/ Output Mapping
# ------------------------------------------
setupDat['inp'] = []                                                                                                    # names of the input variables (X) if empty all
setupDat['out'] = ['state']                                                                                             # names of the output variables (y)
...
setupDat['threshold'] = 0.5                                                                                             # 0) no threshold x) threshold to transform regressio into classification data
...
# Solver
# ------------------------------------------
setupPar['method'] = 1                                                                                                  # 0) regression, 1) classification
...
setupPar['feat'] = 1                                                                                                    # 0) raw data values, 1) statistical features (frame based), 2) statistical features (input based), 3) input and frame based features
setupPar['init'] = 0                                                                                                    # 0) no initial values 1) adding initial values from y
setupPar['window'] = 500                                                                                                # window length (samples)
...
setupPar['nDim'] = 2                                                                                                    # input dimension for model 2) or 3)
...
# Model Parameters
# ==============================================================================
setupMdl = mdlParaJournal(setupMdl)
