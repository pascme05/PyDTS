...
# Names
# ------------------------------------------
setupExp['name'] = 'lectureOpti1'                                                                                       # Name of the simulation
...
setupPar['window'] = 12                                                                                                 # window length (samples)
setupPar['overlap'] = 11                                                                                                # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 0                                                                                                  # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 11                                                                                                 # focus point for seq2point (average if -1)
