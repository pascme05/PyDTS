...
# Names
# ------------------------------------------
setupExp['name'] = 'lectureBase'                                                                                        # Name of the simulation
...
setupPar['window'] = 24                                                                                                 # window length (samples)
setupPar['overlap'] = 23                                                                                                # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 0                                                                                                  # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 23                                                                                                 # focus point for seq2point (average if -1)
