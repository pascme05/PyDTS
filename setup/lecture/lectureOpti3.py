...
#######################################################################################################################
"""
For this example the LSTM parameters in \src\model must be changed as described in the lecture under \docu.
"""
...
# Names
# ------------------------------------------
setupExp['name'] = 'lectureOpti3v3'                                                                                       # Name of the simulation
...
setupPar['window'] = 15                                                                                                 # window length (samples)
setupPar['overlap'] = 14                                                                                                # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 0                                                                                                  # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 14                                                                                                 # focus point for seq2point (average if -1)
setupPar['nDim'] = 3                                                                                                    # input dimension for model 2) or 3)

# ------------------------------------------
# Postprocessing
# ------------------------------------------
setupPar['rank'] = 1                                                                                                     # 0) no feature ranking, 1) feature ranking, 2) Ranking Inp-Out, 3) Ranking Inp-Inp
